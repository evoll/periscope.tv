...
title Periscope video downloader v2.1.1

echo +-----------------------------------------------+
echo ^|        Periscope video downloader v2.1.1       ^|
echo +-----------------------------------------------+
echo ^|          Made by Evoll     2017-01-20          ^|
echo +-----------------------------------------------+
echo.
...
start /min _bin\download.cmd "%url%" %convert% %rotate%
