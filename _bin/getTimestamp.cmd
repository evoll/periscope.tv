...
@goto :batch
::
::getTimestamp.cmd version 2.3 by Dave Benham
::
::  Release History:
...
:::
:::
:::  GetTimestamp.cmd was written by Dave Benham and originally posted at
...
:: Display version
if defined -v (
  for /f "tokens=* delims=:" %%A in ('findstr "^::getTimestamp\.cmd" "%~f0"') do @echo(%%A
  exit /b 0
)
